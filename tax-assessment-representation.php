<?php 
$title = 'Tax Assessment Litigation and Representation Services in India'; 
$pageDescription='Valcus has intelligent group of experts to help in Tax Assessment Litigation and Representation Services in India.';
...
<section class="page-title-custom">
  <div class="container">
    <div class="row">
    	<h1 class="font-weight-8 text-center color-white">Tax Assessment & Representation</h1>   
    </div>
  </div>
</section>
