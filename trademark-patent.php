<?php 
$title = 'Valcus: We offer Trademark / Patent Services'; 
...
<section class="page-title-custom">
  <div class="container">
    <div class="row">
    	<h1 class="font-weight-8 text-center color-white">TRADEMARK / PATENT</h1>
    </div>
  </div>
</section>
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
         <div class="col-md-12 nopadding">
          <div class="text-left">
			<div class="row">
			  <div class="col-md-4">
				<p><a href="">Trademark Registration in India</a></p>
				<p><a href="">International Trademark filing</a></p>
				<p><a href="">Renewal of Trademark Registration</a></p>
			  </div>
			  <div class="col-md-4">
				<p><a href="">Patent Registration in India</a></p>
				<p> <a href="">International Patent Filling</a> </p>
                <p> <a href="">Patent Renewals</a> </p>
                <p> <a href="">Design Registration</a> </p>
			  </div>
			   <div class="col-md-4">
				 <p> <a href="">Types of Copyright</a> </p>
     			 <p> <a href="">Copyright Registration</a> </p>
			     <p> <a href="">Copyright of Software</a> </p> 
			     <p> <a href="">International Copyright Registration</a> </p>
			  </div>
			</div>
	      </div><!--end right col-->
         </div>
