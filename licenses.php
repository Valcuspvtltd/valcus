<?php 
$title = 'Valcus: We offer Licenses Services'; 
...
<section class="page-title-custom">
  <div class="container">
    <div class="row">
    	<h1 class="font-weight-8 text-center color-white">Licenses</h1> 
    </div>
  </div>
</section>
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
         <div class="col-md-12 nopadding">
          <div class="text-left">
			<div class="row">
			  <div class="col-md-4">
				<p><a href="shops-establishment-registration.php">Shops & Establishment Registration</a></p>
				<p><a href="professional-tax-registration.php">Professional Tax Registration</a></p>
				<p><a href="trade-license.php">Trade License</a></p>
				<p><a href="msme-registration.php">MSME Registration</a></p>
			  </div>
			  <div class="col-md-4">
				<p><a href="import-export-code.php">Import Export Code (IEC)</a></p>
				<p> <a href="drug-license.php">Drug License</a> </p>
                <p> <a href="fssai.php">FSSAI (Food License)</a> </p>
                <p> <a href="barcode-registration.php">BarCode Registration</a> </p>
			  </div>
			   <div class="col-md-4">
				 <p> <a href="private-security-license.php">Private Security License(PSARA)</a> </p>
     			 <p> <a href="apeda-registration.php">APEDA Registration</a> </p>
			     <p> <a href="provident-fund-registration.php">Provident Fund Registration</a> </p> 
			     <p> <a href="esic-registration.php">ESIC Registration</a> </p>
			  </div>
			</div>
	      </div><!--end right col-->
         </div>
